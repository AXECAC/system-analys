...
- Обеспечение стабильной работы приложения без потери соединения во время партии (реализация механики ограниченного числа отмен при технических сбоях). // Нас попросили описать, что такое стабильная работа
