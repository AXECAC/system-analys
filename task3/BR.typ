...
- Создать веб-интерфейс (или раздел в админ-панели) для просмотра жалоб от игроков, логов чата и истории нарушений.
- Модератор должен иметь возможность принять решение по жалобе (предупреждение, блокировка чата, временная или постоянная блокировка аккаунта) с обязательным указанием причины.
...
- US-MOD1: Как модератор сообщества, я хочу получать уведомления о новых жалобах на игроков в реальном времени, чтобы оперативно реагировать на токсичное поведение и поддерживать здоровую атмосферу в комьюнити.

- US-MOD2: Как модератор, я хочу видеть полную историю нарушений конкретного пользователя (включая скриншоты/логи чата), чтобы принимать объективное решение о блокировке, а не действовать на основе единичного инцидента.

- US-MOD3: Как модератор, я хочу иметь возможность заморозить аккаунт нарушителя на время разбирательства, чтобы предотвратить дальнейшее распространение оскорблений или читерства.
